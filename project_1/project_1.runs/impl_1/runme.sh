...
HD_PWD='C:/Users/joshu/Desktop/test/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tally.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tally.tcl -notrace
