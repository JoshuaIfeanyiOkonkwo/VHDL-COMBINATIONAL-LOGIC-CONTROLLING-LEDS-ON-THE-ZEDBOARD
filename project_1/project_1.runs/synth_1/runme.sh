...
HD_PWD='C:/Users/joshu/Desktop/test/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tally.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tally.tcl
