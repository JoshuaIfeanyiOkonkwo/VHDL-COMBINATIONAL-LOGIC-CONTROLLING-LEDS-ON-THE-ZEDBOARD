...
# Asign to vector A
set_property PACKAGE_PIN F22 [get_ports {scoresA[0]}];  # SW0
set_property PACKAGE_PIN G22 [get_ports {scoresA[1]}];  # SW1
set_property PACKAGE_PIN H22 [get_ports {scoresA[2]}];  # SW2

# Asign to vector B
set_property PACKAGE_PIN F21 [get_ports {scoresB[0]}];  # SW3
set_property PACKAGE_PIN H19 [get_ports {scoresB[1]}];  # SW4
set_property PACKAGE_PIN H18 [get_ports {scoresB[2]}];  # SW5

set_property IOSTANDARD LVCMOS33 [get_ports {scoresA[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {scoresB[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {winner[*]}]
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {winner[1]}];  # LD0
set_property PACKAGE_PIN T21 [get_ports {winner[0]}];  # LD1
